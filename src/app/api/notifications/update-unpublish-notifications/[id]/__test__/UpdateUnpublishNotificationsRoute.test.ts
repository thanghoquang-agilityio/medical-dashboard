...
describe('UpdateUnpublishNotifications route handler', () => {
  let mockRequest: Request;

  beforeEach(() => {
    mockRequest = new Request(
      `${HOST_DOMAIN}/${ROUTE_ENDPOINT.NOTIFICATIONS.UPDATE_UNPUBLISH_NOTIFICATION}/1`,
      {
        method: 'PUT',
      },
    );
  ...
  it('should update unpublish notifications and return the response', async () => {
